 ...
 */
export function formatSimResult(sim, programLabel) {
    ...
    const preHandlerEncodingError = /InstructionDidNotDeserialize|InvalidInstructionData|insufficient account keys|Failed to (de)?serialize|Program failed to complete|An account required by the instruction is missing/i.test(errStr + '\n' + logStr);
