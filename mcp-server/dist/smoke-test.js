...
const cases = [
    ...
    },
    {
        ...
        fn: () => handleResearchTool('chaingpt_research_token', { query: WETH_ETH, chain: 'ethereum' }),
        expect: /WETH|Wrapped Ether/i,
    },
    {
        name: 'research_pairs (USDC pairs on base)',
        fn: () => handleResearchTool('chaingpt_research_pairs', {
            address: USDC_BASE,
            chain: 'base',
            limit: 3,
        }),
    ...
    // ─── Tier 1: risk ────────────────────────────────────────────────
    {
        ...
        fn: () => handleRiskTool('chaingpt_risk_token', { address: USDC_ETH, chain: 'ethereum' }),
        expect: /USDC|Token security/i,
    },
    {
        name: 'risk_address (Vitalik wallet)',
        fn: () => handleRiskTool('chaingpt_risk_address', { address: VITALIK, chain: 'ethereum' }),
        expect: /Address risk/i,
    },
    {
        name: 'risk_contract_source (USDC verified source — or friendly key-missing hint)',
        fn: () => handleRiskTool('chaingpt_risk_contract_source', {
            address: USDC_ETH,
            chain: 'ethereum',
            previewChars: 200,
        }),
    ...
    },
    {
        ...
        fn: () => handleOnchainTool('chaingpt_onchain_address', {
            address: VITALIK,
            chain: 'ethereum',
            limit: 3,
        }),
    ...
    // ─── Tier 1: wallet ──────────────────────────────────────────────
    {
        ...
        fn: () => handleWalletTool('chaingpt_wallet_balances', {
            address: VITALIK,
    ...
    // ─── Tier 2: deploy (compile only — no network needed) ───────────
    {
        ...
        fn: () => handleDeployTool('chaingpt_deploy_compile', {
...
contract Hello { string public greeting = "hi"; }`,
    ...
    },
    {
        ...
        fn: () => handleDeployTool('chaingpt_deploy_build_tx', {
    ...
    },
    {
        ...
        fn: () => handleDexTool('chaingpt_dex_build_swap_tx', {
            network: 'ethereum',
            inToken: '0x0000000000000000000000000000000000000000',
            outToken: USDC_ETH,
            amountIn: '0.01',
    ...
    },
    {
        ...
        fn: () => handleDexTool('chaingpt_dex_jupiter_quote', {
            inputMint: SOL_MINT,
    ...
    // ─── Tier 3d: DeFi (Aave health read only) ───────────────────────
    {
        ...
        fn: () => handleDefiTool('chaingpt_defi_aave_health', {
            user: VITALIK,
            network: 'ethereum',
        }),
    ...
    },
    {
        ...
        fn: () => handleDefiTool('chaingpt_defi_aave_supply_tx', {
            asset: USDC_ETH,
            amount: '100',
            decimals: 6,
            from: VITALIK,
    ...
    },
    {
        ...
        fn: () => handleDefiTool('chaingpt_defi_lido_stake_tx', {
            amountEth: '1.0',
            from: VITALIK,
        }),
    ...
    // ─── Tier 3c: Polymarket ─────────────────────────────────────────
    {
        ...
        fn: () => handlePolymarketTool('chaingpt_pm_markets', { limit: 3, order: 'volume24hr', active: true }),
    ...
    // ─── Tier 6.1: Across bridge ─────────────────────────────────────
    {
        ...
        fn: () => handleBridgeTool('chaingpt_bridge_quote', {
    ...
    },
    {
        ...
        fn: () => handleBridgeTool('chaingpt_bridge_build_deposit_tx', {
            inputToken: USDC_BASE,
            outputToken: USDC_ETH,
            originChain: 'base',
            destinationChain: 'ethereum',
    ...
    // ─── Tier 6.2: 1inch + CoW aggregators ───────────────────────────
    {
        ...
        fn: () => handleAggregatorTool('chaingpt_dex_1inch_quote', {
            network: 'ethereum',
            inToken: USDC_ETH,
            outToken: WETH_ETH,
            amountIn: '100',
    ...
    },
    {
        ...
        fn: () => handleAggregatorTool('chaingpt_dex_cow_create_order', {
            network: 'ethereum',
            sellToken: USDC_ETH,
            buyToken: WETH_ETH,
            sellAmount: '100',
    ...
    // ─── Tier 6.3: Pendle + Morpho ───────────────────────────────────
    {
        ...
        fn: () => handleYieldTool('chaingpt_defi_pendle_markets', { network: 'ethereum', limit: 3 }),
        expect: /Pendle active markets/i,
        expectData: /TVL: \$\d[\s\S]*Fixed APY \(buy PT\):\s+\d/,
    },
    {
        name: 'defi_morpho_markets (ethereum)',
        fn: () => handleYieldTool('chaingpt_defi_morpho_markets', { network: 'ethereum', limit: 3 }),
        expect: /Morpho Blue markets/i,
        expectData: /Supply APY: \d[\s\S]*Supply TVL: \$\d/,
    },
    {
        name: 'defi_morpho_vaults (ethereum USDC)',
        fn: () => handleYieldTool('chaingpt_defi_morpho_vaults', { network: 'ethereum', asset: 'USDC', limit: 3 }),
    ...
    // ─── Tier 8: portfolio snapshot ──────────────────────────────────
    {
        ...
        fn: () => handlePortfolioTool('chaingpt_portfolio_snapshot', {
            evmAddress: VITALIK,
...
if (skipDrift)
    console.log(`${YELLOW}  (SKIP_DRIFT_SMOKE=1 — drift cases excluded)${RESET}`);
console.log();
for (const c of filteredCases) {
    ...
    try {
        ...
        const matches = c.expect instanceof RegExp ? c.expect.test(text) : text.includes(c.expect);
